 ...
 * @date   2019-06-25.
 */
class BaseLightModeHeadView @JvmOverloads constructor(
    context: Context,
    ...
    init {
        ...
        layoutHeadView.setBackgroundColor(context.resources.getColor(R.color.white))
        ivHeadBack.setImageResource(R.drawable.qmui_dialog_bg)
        tvHeadTitle.setTextColor(context.resources.getColor(R.color.white))

        statusBarView.setBackgroundColor(context.resources.getColor(R.color.white))
